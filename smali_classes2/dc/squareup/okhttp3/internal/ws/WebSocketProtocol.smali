.class public final Ldc/squareup/okhttp3/internal/ws/WebSocketProtocol;
...
.method static toggleMask(Ldc/squareup/okio/Buffer$UnsafeCursor;[B)V
    .locals 7
    ...
    .line 3
    :cond_0
    iget-object v2, p0, Ldc/squareup/okio/Buffer$UnsafeCursor;->data:[B

    .line 4
    iget v3, p0, Ldc/squareup/okio/Buffer$UnsafeCursor;->start:I

    iget v4, p0, Ldc/squareup/okio/Buffer$UnsafeCursor;->end:I
    ...
    .line 8
    :cond_1
    invoke-virtual {p0}, Ldc/squareup/okio/Buffer$UnsafeCursor;->next()I
...
.method static validateCloseCode(I)V
    ...
    .line 1
    invoke-static {p0}, Ldc/squareup/okhttp3/internal/ws/WebSocketProtocol;->closeCodeExceptionMessage(I)Ljava/lang/String;
